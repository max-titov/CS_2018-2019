...
public class ShapeTester extends JPanel {
	...
	public ShapeTester() {
		...
		Square leftSquare = new Square(0, 100, 100, 0, Color.YELLOW);
		Square square = new Square(500, 200, 100, 0, Color.RED);
		Triangle triangle = new Triangle(200, 500, 100, 3, Color.CYAN);
